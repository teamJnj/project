...
$(function () {
	...
	$("#writeBtn").on("click", function() {
		console.log("클릭");
	  var form = $("#form");
	  //$("<input type='hidden' id='findAddr11' name='findAddr' value='"+$("#addr2").val()+"'>").appendTo(form);	
...
<body>
	...
	<br>
	<hr>
	<form id="form" action="/jnj/menu/board_find/write" method="post" enctype="multipart/form-data">
...
<table id="table">
	<article class="container">
		...
		<tr>
			<th>펫이름</th>
			<td>
				<input type="text" id="petName" class="btn btn-default" name="petName" placeholder="펫이름">
			</td>
		</tr>
		<tr><td></td>
			<td>
		...
		<tr>
			<th>펫나이</th>
			<td>
				<input type="text" class="btn btn-default" id="petAge" name="petAge" placeholder="펫나이">
			</td>
		</tr>
		<tr><td></td>
			<td>
	...
	<!-- 지도를 표시할 div 입니다
<div id="map" style="width:600px; height:350px; margin-left: 270px; margin-top: 30px; margin-bottom: 60px;"></div>

<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c02f43d2c62635fda30f33785e1785d5"></script>
<script>
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new daum.maps.LatLng(48.450701, 126.570667), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
