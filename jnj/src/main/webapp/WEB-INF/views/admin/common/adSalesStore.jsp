	...
	<script>
		...
		$(function(){
			...
			$("#searchBtn").on( "click", function (){
				...
				$.ajax({
					url 	: "/jnj/admin/sales_store/sort",
					type 	: "get", 
			...
			$(".pagination").on("click", "a[class=page-link]", function(e){
				...
				location.href="/jnj/admin/sales_store?"+formDataSetting();
			});
			...
			function initValues( map ){
				...
				$salesStoreList = map.salesStoreList;
				$info = map.adSalesStoreInfo;
				$pagination = map.pagination;
				$totalStoreMoney = map.totalStoreMoney;
			}
			...
			function display_setting( state ){
				...
				$.each($salesStoreList, function(idx, sales) {
					...
					table.row.add( [
						...
						sales.orderDate,
						currentOrderState(sales.orderState)
			        ]).draw(false);
					
				});
				
				$("#total").text(numberWithCommas($totalStoreMoney) + "원");
...
<body>
    ...
    <div class="content-wrapper">
    	<div class="container-fluid">
    		...
    		<div id="tableTotal">
			<div class="card mb-3">
				<div class="card-header"> <i class="fa fa-table"></i> 스토어 매출 내역 </div>
					<div class="card-body">
