	...
	<script>
		...
		$(function(){
			...
			$(".pagination").on("click", "a[class=page-link]", function(e){
				...
				location.href="/jnj/admin/center_qna?"+formDataSetting();
			});
			...
			$("#qnaTable").on("click", ".titleClick", function(){
				...
				console.log( "상세보기 클릭 : " + $center.centerId );
				location.href="/jnj/admin/center_qna/view?qnaNo="+$qnaList[$(this).attr("data-idx")].qnaNo+"&writeId="+$center.centerId;
			});
			...
			function formDataSetting(){
				...
				if( $info.centerId != null ) $("<input type='hidden' name='writeId' value='"+$info.centerId+"' >").appendTo( form );
				if( $info.centerId != null ) $("<input type='hidden' name='centerId' value='"+$info.centerId+"' >").appendTo( form );
				if( $info.qnaDivision != null ) $("<input type='hidden' name='qnaDivision' value='"+$info.qnaDivision+"' >").appendTo( form );
