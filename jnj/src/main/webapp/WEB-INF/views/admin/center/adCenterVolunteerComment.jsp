	...
	<script>
		...
		$(function(){
			...
			$("#searchBtn").on( "click", function (){
				...
				$.ajax({
					url 	: "/jnj/admin/center_volunteer/comment/sort",
					type 	: "get", 
			...
			$(".pagination").on("click", "a[class=page-link]", function(e){
				...
				console.log("duirl");
				location.href="/jnj/admin/center_volunteer/comment?"+formDataSetting();
			});
			...
			$("#volTable").on("click", ".title", function(e){
				...
				//location.href="/jnj/admin/center_volunteer/view?volunteerNo="+$memberVolunteerCommentList[$(this).attr("data-idx")].volunteerNo+"&centerId="+$center.centerId;
				
				window.open("/jnj/admin/center_volunteer/view?volunteerNo="+$memberVolunteerCommentList[$(this).attr("data-idx")].volunteerNo+"&centerId="+$center.centerId,
			...
			$("#myModal").on("click", "#cancleBtn", function(){
		    	...
		    	$.ajax({
					url : "/jnj/admin/center_volunteer/comment_delete",
					type : "post",
			...
			function formDataSetting(){
				...
				if( $info.centerId != null ) $("<input type='hidden' name='writeId' value='"+$info.writeId+"' >").appendTo( form );
