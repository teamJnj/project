...
<head>
	...
	<script>
		...
		$(function(){
			...
			var $detailState;
			var $center;
			var $getMypageCenterVolunteerList;
			var $pagination;
			...
			$("#myModal").on("click", "#yesBtn", function(){
				...
				$.ajax({
					url : "/jnj/admin/center_volunteer/apply_cancle",
					type : "post",
					data : {
						"volunteerNo" : $getMypageCenterVolunteerList[index].volunteerNo,
						"applyId" : $getMypageCenterVolunteerList[index].memberId,
			...
			$("#myModal").on("click", "#selectYesBtn", function(){
				...
				$("input[name='check']:checked").each(function(idx) {
			    	...
			    	var obj = $getMypageCenterVolunteerList[$(this).attr("data-idx")];
				...
				$("<input type='hidden' name='detailState' value='"+$detailState +"' multiple='multiple' >").appendTo(form);
			...
			function initValues( map ){
				...
				$getMypageCenterVolunteerList = map.getMypageMemberVolunteerList;
			...
			function display_setting( state ){
				...
				var total = 0;
				$.each($getMypageCenterVolunteerList, function(idx, apply) {
